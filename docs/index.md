...
#### 2022/05/13頃から録音が正常に完了しない（途中で終了やノイズが入る）障害が発生しているようです。ffmpegをバージョン3.2にすることで回避できるようです。ffmpegをバージョン3.2は[こちらから入手できます。](https://ffbinaries.com/downloads#version_3.2)ご利用のOSにあったffmpegをダウンロードし、アプリ(CS-English/CS-Mult)と同じフォルダ内にあるffmpegと置き換えてください。
