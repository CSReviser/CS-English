...
#### 2023/01/04現在、xmlの情報が取得できていない不具合を確認しています。2023/01/05版をリリースしました。また、mp3を選択したときのffmpegのオプションに「-write_xing 0」を追加しました。CBR時は必要なオプションのようです。mp3を利用されている方は更新を推奨します。               

#### 語学講座CS2(仮称)のベータテストβ１.1を公開しました。β１のバグ修正版です。差し替えをお願い致します。語学講座CS2に統合することで語学講座CS【English】/【Mult】版のアップデートは2022年度末(2023/3末)で終了します。2023年度もNHK語学講座を受講予定の方は、この機会に[［類似アプリ］](https://github.com/CSReviser/CS-English/wiki/%E9%A1%9E%E4%BC%BC%E3%82%A2%E3%83%97%E3%83%AA)など、他のアプリに乗り換え、移行をご検討ください。              
