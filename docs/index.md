...
#### 2022/05/13頃のNHKサイトの仕様変更に伴い、拡張子「mp3」を選択するとファイルサイズが従来の約２倍になることへの対応。従来と同じファイルサイズになるように変更した版をリリースしました。ffmpeg5.0.1に対応しています。4.2.x以前は使えませんのでご注意ください。Mac版は環境がない為、動作未確認です。              
