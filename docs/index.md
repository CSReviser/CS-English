...
#### カスタマイズメニュー（ファイル名、タグタイトル）を2022年度の講座にあわせて更新しました。長らく更新できずに放置していましたが、2022年度の講座対応で更新したつもりです。まだバグがある可能性があります。また、デフォルトの拡張子は「m4a」に変更しています。「mp3」を選択すれば従来通りmp3で録音されます。              
